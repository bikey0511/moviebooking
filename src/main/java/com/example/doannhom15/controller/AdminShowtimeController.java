...
public class AdminShowtimeController {
    ...
    private static final DateTimeFormatter DATETIME_LOCAL_MIN = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm");
    ...
    public String newShowtime(@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
        ...
        LocalDateTime minDt = d.equals(LocalDate.now()) ? LocalDateTime.now() : d.atStartOfDay();
        ...
        model.addAttribute("minStartTime", minDt.format(DATETIME_LOCAL_MIN));
    ...
    public String saveShowtime(@RequestParam Long movieId,
        ...
        try {
            ...
            LocalDate rd = returnDate != null ? clampToWeek(returnDate) : LocalDate.now();
            return "redirect:/admin/showtimes/new?date=" + rd;
        }
        ...
        LocalDate rd = returnDate != null ? clampToWeek(returnDate) : start.toLocalDate();
        return "redirect:/admin/showtimes?date=" + rd;
    }
