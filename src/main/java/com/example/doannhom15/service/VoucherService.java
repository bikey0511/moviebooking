...
public class VoucherService {
    public static final int MAX_USES_PER_USER_TICKET = 2;
    public static final int MAX_USES_PER_USER_CONCESSION = 3;
    ...
    public int maxUsesPerUser(Voucher voucher) {
        ...
        return voucher.getDiscountType() == Voucher.DiscountType.TICKET
                ? MAX_USES_PER_USER_TICKET
                : MAX_USES_PER_USER_CONCESSION;
    }
